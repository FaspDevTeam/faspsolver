                          ...
                          REAL rtol)
{
    ...
    REAL *u0,*r0,*b0;
    REAL norm_r,norm_r0,error;
    INT i, k, count, max_itr_num, *nxk, *nyk, *level;
                          ...
                          REAL rtol)
{
    ...
    REAL *u0,*r0,*b0;
    REAL norm_r,norm_r0,error;
    int i, k, max_itr_num, count, *nxk, *nyk, *nzk, *level;
                              ...
                              REAL rtol)
{
    ...
    REAL *u0,*r0,*b0;
    REAL norm_r0;
    int i, k, max_itr_num, *nxk, *nyk, *level;        
                              ...
                              REAL rtol)
{
    ...
    REAL *u0,*r0,*b0;
    REAL norm_r0;
    int i, k, max_itr_num,  *nxk, *nyk, *nzk, *level;
