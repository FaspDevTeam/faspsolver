...
In Linux, Mac OS X, or Windows, you can use the Scons tool to build and install different versions (Release, Shared, Debug) of the FASP library. You just need to type inside ``\url{faspsolve/base}'' directory:
%
\begin{lstlisting}[numbers=none]
$ scons -Q install
\end{lstlisting}
...
%
\begin{snugshade}\noindent
NOTE: The above function decorations are taken from ``\url{base/include/fasp\_functs.h}''. This header file is automatically generated based on the source codes. Users are NOT supposed to change it by hand. 
\end{snugshade}
...
%
\lstinputlisting[language=C,firstnumber=254,firstline=254,lastline=283]{../test/main/testgmg.c}
%
