...
% 3rd version for FASP 1.8.1 by Chensong Zhang and Ludmil Zikatanov
...
distribution). 
All the examples can be found inside ``\url{faspsolver/tutorial/}''. 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{How to change parameters in
...
\begin{snugshade}\noindent
  NOTE: The default FSP build is a RELEASE version and such version
