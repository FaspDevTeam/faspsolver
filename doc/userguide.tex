...
\date{\vfill Version 1.9.8} % Activate to display a given date or no date
...
%
\lstinputlisting[language=C,firstnumber=468,firstline=468,lastline=579]{../base/include/fasp_functs.h}
%
\begin{snugshade}\noindent
...
%
\lstinputlisting[firstnumber=489,firstline=489,lastline=502]{../base/src/SolCSR.c}
%
...
%
\lstinputlisting[language=C,numbers=none,firstline=97,lastline=121]{../base/include/fasp_const.h}
%
...
%
\lstinputlisting[language=C,firstnumber=46,firstline=46,lastline=143]{../base/src/SolAMG.c}
%
