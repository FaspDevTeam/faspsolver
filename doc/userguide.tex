...
First, you need to obtain a free copy of FASP kernel functions from \emph{BitBucket.org} via HTTPS or SSH or SourceTree:
%
\begin{lstlisting}[numbers=none]
"Download FASP using HTTPS"
$ hg clone https://faspusers@bitbucket.org/fasp/faspsolver
"Download FASP using SSH"
$ hg clone ssh://hg@bitbucket.org/fasp/faspsolver
"Download FASP using SourceTree"
$ sourcetree://cloneRepo/https://faspusers@bitbucket.org/fasp/faspsolver
\end{lstlisting}
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Classical AMG}\label{sec:camg}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Aggregation-based AMG}\label{sec:samg}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
