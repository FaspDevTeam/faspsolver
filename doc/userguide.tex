...
\date{\vfill Version 1.9.9} % Activate to display a given date or no date
...
%
\lstinputlisting[language=C,firstnumber=469,firstline=469,lastline=580]{../base/include/fasp_functs.h}
%
\begin{snugshade}\noindent
