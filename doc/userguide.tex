...
\end{lstlisting}
\begin{snugshade}
  While these two approaches to building the FASP test suite and the
  FASP examples
...
examples. They use minimal information about the library build stored
in  \verb|$(faspsolver)/Config.mk|. A typical contents of such file is
given below:
...
#
#######################################################################
fasp_prefix=/users/janedoe/faspsolver
CC=gcc
CXX=g++
FC=gfortran
#######################################################################
...
and
\verb|$(faspsolver)/tutorial/Makefile| or in your own Makefile. An external project can be
compiled and linked with FASP support, just by following the rules 
set in \verb|$(faspsolver)/tutorial/makefile|, which is included 
below:
