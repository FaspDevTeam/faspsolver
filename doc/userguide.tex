...
\end{lstlisting}
%
To uninstall FASP and clean up the working directory, you can 
%
\begin{lstlisting}[numbers=none]
$ make uninstall
$ make distclean
...
\end{lstlisting}
%
A graphical interface will popup and the rest of the building process is straightforward. 
