...
\date{Version 1.0.0} % Activate to display a given date or no date
...
\begin{snugshade}\noindent
NOTE: By default, OpenMP is not enabled in FASP. In order to turn it on, you need to do a few things:
\end{snugshade}
