 ...
 *  \brief setup phase for schwarz method
 *
 *  Created by Hu Xiaozhe on 3/22/11.
 *  Copyright 2011 PSU. All rights reserved.
 *
 */
...
{ 
...
#if DEBUG_MODE
	fprintf(stdout,"\nYYYNumber of nonzeroes for LU=%d maxbs=%d\n",memt, maxbs);
#endif
	...
	printf("Schwarz setup success:  matrix size = %d, #blocks = %d, max block size =%d\n", n, nblk, maxbs);
